...
# Date
text2 = {'a11': Label(frame11, text="date", fg="red", font=("arial", 10), bg="#e6e6e6"), 'a22': Label(frame22, text="date", fg="red", font=("arial", 10), bg="#e6e6e6"), 'a33': Label(frame33, text="date", fg="red", font=("arial", 10), bg="#e6e6e6"), 'a44': Label(frame44, text="date", fg="red", font=("arial", 10), bg="#e6e6e6"), 'a55': Label(frame55, text="date", fg="red", font=("arial", 10), bg="#e6e6e6")}
...
#                 publisher = volume_info.get('publisher', 'N/A')
#                 published_date=volume_info.get('publishedDate', 'N/A')
#                 author=volume_info.get('author',['N/A'])
#                 rating=volume_info.get('authors',['N/A'])
...
#                 if check_var.get() or check_var2():
#                     frame11.place(x=160, y=600)
#                     frame22.place(x=360, y=600)
#                     frame33.place(x=560, y=600)
#                     frame44.place(x=760, y=600)
...
#         else:
#             print("Failed to fetch data from Google Books API")
#             messagebox.showinfo("info", "Failed to fetch data from Google Bools API.")
...
# #Search Button
# recommend_button_image=PhotoImage(file="Images/Search.png")
# recommend_button = Button(root, image=recommend_button_image, bg="#0099ff", bd=0, activebackground="#252532", cursor="hand2")
# recommend_button.place(x=860, y=169)
